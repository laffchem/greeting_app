#!/usr/bin/env python
"""
Package metadata for greeting_app.
"""
import os
import re
import sys
...
VERSION = get_version('greeting_app', '__init__.py')
...
setup(
    name='greeting_app',
    version=VERSION,
    description="""short greeting api""",
    long_description=README + '\n\n' + CHANGELOG,
    author='edX',
    author_email='oscm@edx.org',
    url='https://github.com/openedx/greeting_app',
    packages=find_packages(
        include=['greeting_app', 'greeting_app.*'],
        exclude=["*tests"],
    ),
