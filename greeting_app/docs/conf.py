...
"""
greeting_app documentation build configuration file.
...
#
# html_title = 'greeting_app v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'short greeting api',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'greeting_app'),
                os.path.join(root_path, 'greeting_app/migrations')])
